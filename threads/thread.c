...
#define Q0_TIME_SLICE 2
#define Q1_TIME_SLICE 4
#define Q2_TIME_SLICE 8
...
thread_tick (void)
{
    ...
    if (thread_mlfqs) {
        ...
        {
        case 0:
            if (++thread_ticks >= Q0_TIME_SLICE)
                intr_yield_on_return();
            break;
        case 1:
            if (++thread_ticks >= Q1_TIME_SLICE)
                intr_yield_on_return();
            
            break;
        case 2:
            if (++thread_ticks >= Q2_TIME_SLICE)
                intr_yield_on_return();            
            break;        
        }
